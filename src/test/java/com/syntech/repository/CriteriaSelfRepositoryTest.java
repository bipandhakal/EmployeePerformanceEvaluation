...
public class CriteriaSelfRepositoryTest {
    ...
    public void createTest() {
        CriteriaSelf crs1 = new CriteriaSelf(1L, criteria, 15.0);
    ...
    public void findAllTest() {
        CriteriaSelf crs1 = new CriteriaSelf(2L, criteria, 10.0);
        criteriaSelfRepository.create(crs1);
        assertEquals(1, criteriaSelfRepository.findAll().size());
    }
    ...
    public void deleteTest() {
        CriteriaSelf crs2 = new CriteriaSelf(2L, criteria, 20.0);
    ...
    public void findByIdTest() {
        CriteriaSelf crs3 = new CriteriaSelf(3L, criteria, 20.0);
    ...
    public void editTest() {
        CriteriaSelf crs4 = new CriteriaSelf(4L, criteria, 21.0);
