...
public class SupervisorEvaluationRepositoryTest {
    ...
    public void createTest() {
        SupervisorEvaluation supervisorEvaluation = new SupervisorEvaluation(1L, obj.getMonths(), obj.getEmployee(), obj.getCriteria(), +10.0);
    ...
    public void deleteTest() {
        SupervisorEvaluation supervisorEvaluation = new SupervisorEvaluation(2L, obj.getMonths(), obj.getEmployee(), obj.getCriteria(), -10.0);
        supervisorEvaluationRepository.create(supervisorEvaluation);
    ...
    public void findByIdTest() {
        SupervisorEvaluation supervisorEvaluation = new SupervisorEvaluation(3L, obj.getMonths(), obj.getEmployee(), obj.getCriteria(), -2.0);
        supervisorEvaluationRepository.create(supervisorEvaluation);
    ...
    public void editTest() {
        SupervisorEvaluation supervisorEvaluation = new SupervisorEvaluation(4L, obj.getMonths(), obj.getEmployee(), obj.getCriteria(), +2.0);
        supervisorEvaluationRepository.create(supervisorEvaluation);
