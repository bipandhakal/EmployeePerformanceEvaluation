...
public class CriteriaTrueFalseRepositoryTest {
    ...
    public void createTest() {
        CriteriaTrueFalse crtf = new CriteriaTrueFalse(1L, 1L, "Present", 10.0);
    ...
    public void findAllTest() {
        CriteriaTrueFalse crtf = new CriteriaTrueFalse(2L, 1L, "Absent", 1.0);
        criteriaTrueFalseRepository.create(crtf);
        assertEquals(1, criteriaTrueFalseRepository.findAll().size());
    }
    ...
    public void findByIdTest() {
        CriteriaTrueFalse crtf = new CriteriaTrueFalse(3L, 1L, "Present", 10.0);
        criteriaTrueFalseRepository.create(crtf);
